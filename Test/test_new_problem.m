...
% path_lp = "D:\git_repository\Stage-K2.5\Problems\lp_prob\";
% list_problem = ls(path_lp);
% list_problem = path_lp + cellstr(list_problem(3:end,:));

% path_milp = "D:\git_repository\Stage-K2.5\Problems\milp_prob\";
% list_problem = ls(path_milp);
% list_problem = path_milp + cellstr(list_problem(3:end,:));
...
list_problem = {path_qp+"qafiro.qps"}
