classdef K3 < handle
    ...
    methods
        ...
        function Solve_Newton(o)
            ...
            z1s = o.z1(o.low); Z1s = sparse(1:nlow, o.low, z1s, nlow, o.n);
            z2s = o.z2(o.upp); Z2s = sparse(1:nupp, o.upp, z2s, nupp, o.n);
            ...
            if o.explicitA
                ...
                if o.nfix == 0
                    o.M = [ -o.H    o.A'        speye([size(o.H, 1), size(X1,2)+size(X2,2)])
                    ...
                    o.M = [ -o.H      o.Afree'      speye([size(o.H, 1), size(X1,2)+size(X2,2)])
            ...
            rmu1 = (o.cL(o.low) + o.z1(o.low) .* o.rL(o.low));
            rmu2 = (o.cU(o.upp) + o.z2(o.upp) .* o.rU(o.upp));
